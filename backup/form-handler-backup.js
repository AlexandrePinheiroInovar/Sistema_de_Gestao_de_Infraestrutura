...
(function() {
        ...
        form.addEventListener('submit', async function(e) {
            ...
            try {
                ...
                if (result.success) {
                    ...
                    showMessage('Conta criada com sucesso! O redirecionamento será automático...', 'success');
                    
                    // Redirecionamento será feito pelo onAuthStateChanged do firebase-complete.js
        ...
        form.addEventListener('submit', async function(e) {
            ...
            try {
                ...
                if (result.success) {
                    ...
                    showMessage('Login realizado com sucesso! O redirecionamento será automático...', 'success');
    ...
    function fixAuthLoop() {
        console.log('🔄 [AUTH-FIX] Sistema de correção de loop DESABILITADO');
        console.log('💡 [AUTH-FIX] firebase-complete.js já gerencia o onAuthStateChanged');
        // Função desabilitada para evitar conflitos com firebase-complete.js
    }
